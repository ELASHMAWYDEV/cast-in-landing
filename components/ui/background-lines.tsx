...
export const BackgroundLines = ({
  ...
  return (
    <div
      className={cn(
        "h-[20rem] md:h-screen w-full bg-transparent dark:bg-transparent relative",
        className
      )}
    >
...
const SVG = ({
  ...
  const paths = [
    ...
    "M720 450C720 450 712.336 437.768 690.248 407.156C668.161 376.544 672.543 394.253 665.951 365.784C659.358 337.316 647.903 347.461 636.929 323.197C625.956 298.933 626.831 303.639 609.939 281.01C593.048 258.381 598.7 255.282 582.342 242.504C565.985 229.726 566.053 217.66 559.169 197.116C552.284 176.572 549.348 171.846 529.347 156.529C509.345 141.211 522.053 134.054 505.192 115.653C488.33 97.2527 482.671 82.5627 473.599 70.7833C464.527 59.0039 464.784 50.2169 440.243 39.9551C415.701 29.6934 413.493 32.3767 395.402 13.8031C377.311 -4.77057 394.853 -1.45082 362.123 -23.8931C329.393 -46.3354 341.157 -41.8292 325.733 -56.2994C310.308 -70.7696 322.258 -86.6788 293.348 -101.445C264.438 -116.212 269.97 -111.258 241.873 -136.258C213.777 -161.258 221.622 -151.786 193.031 -169.949C164.441 -188.112 174.406 -185.299 138.148 -194.476C101.89 -203.652 108.739 -206.081 89.3714 -221.475C70.0041 -236.87 56.611 -237.215 38.083 -243.876C19.5549 -250.536 14.418 -257.485 -13.8694 -269.49C-42.1568 -281.494 -37.5413 -285.924 -64.5737 -294.281",
  ...
  const colors = [
    ...
    "#DB2777", // Pink-600
    "#BE185D", // Pink-700
    "#8B5CF6", // Violet-500 (repeat)
    "#C4B5FD", // Violet-300 (repeat)
    "#4F46E5", // Indigo-600 (repeat)
    "#6366F1", // Indigo-500 (repeat)
    "#EC4899", // Pink-500 (repeat)
    "#F472B6", // Pink-400 (repeat)
    "#BE185D", // Pink-700 (repeat)
  ];
  return (
    <motion.svg
